#include "./UDFs/Time.au3"


Opt("WinTitleMatchMode", 3)
SoundSetWaveVolume(25)
_Debug("MAIN[" & _GetCurrentTime12Hour() & "]", "Starting Heal.au3...")
...
Func _Idle()
	...
	If Not WinActive("Path of Exile") Then
		_Debug("_Idle[" & _GetCurrentTime12Hour() & "]", "PoE NOT Active! Pausing Script...")
		WinWaitActive("Path of Exile")
		_Debug("_Idle[" & _GetCurrentTime12Hour() & "]", "PoE Active! Resuming Script...")
	EndIf
	;Pause at Logon Screen and Transit/Loading Screens
	Switch PixelGetColor(104, 909) ; Health
		Case 0, 256, 257, 258, 513, 65793, 131328, 328704, 328962, 922646, 1185818, 1713446, 5180434, 5508372, 9248295
			_Debug("_Idle[" & _GetCurrentTime12Hour() & "]", "Logon/Transit Screen Detected. Pausing Script...")
			Sleep(2000)
			Return SetError(1, 0, False)
	EndSwitch

	Switch PixelGetColor(1787, 1054) ; Mana
		Case 0, 256, 257, 516, 66314, 131586, 204874, 271958, 328709, 338267, 396577, 462372, 601438, 1710100, 1778469, 923160
			_Debug("_Idle[" & _GetCurrentTime12Hour() & "]", "Logon/Transit Screen Detected. Pausing Script...")
			Sleep(2000)
	...
	Switch PixelGetColor(887, 233) ; Dead Screen
		Case 3812396
			_Debug("_Idle[" & _GetCurrentTime12Hour() & "]", "Death Screen Detected. Pausing Script...")
			Sleep(2000)
